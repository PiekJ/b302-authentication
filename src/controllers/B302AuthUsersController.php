 ...
 */
class B302AuthUsersController extends Controller
{
    ...
    public function create()
    {
        ...
        return View::make('b302-auth::users.signup');
    }
    ...
    {
        $repo = App::make('PiekJ\B302Authentication\UserRepository');
    ...
    public function login()
    {
        if (Confide::user()) {
            ...
            return View::make('b302-auth::users.login');
        }
    }
    ...
    {
        return View::make('b302-auth::users.forgot_password');
    }
    ...
    {
        return View::make('b302-auth::users.reset_password')
                ->with('token', $token);
    }
